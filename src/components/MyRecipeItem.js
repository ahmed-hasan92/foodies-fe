...
const MyRecipeItem = ({ recipe, recipeId }) => {
  ...
  return (
    <div class="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-2xl">
      ...
      <div class="absolute inset-0 flex translate-y-[50%] flex-col gap-[20px] items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0 ">
