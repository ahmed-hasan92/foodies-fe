...
const DeleteModal = ({ show, onClose, handleDelete }) => {
      ...
      <div class="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
        <div class="w-full max-w-md bg-white shadow-lg rounded-md px-5 py-4 relative">
          <svg
            ...
            class="w-3 cursor-pointer shrink-0 fill-black hover:fill-red-500 float-right"
          ...
          <div class="my-8 text-center">
            ...
            <h4 class="text-[#333333] text-base font-semibold mt-4">
